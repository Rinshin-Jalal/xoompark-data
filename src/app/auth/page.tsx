        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="w-full max-w-sm">
          ...
          <motion.div variants={itemVariants} className="bg-white border border-[#e5e3e3] rounded-lg p-6">
            ...
            {authMethod === 'email' && (
              <motion.form variants={itemVariants} onSubmit={handleEmailSubmit} className="space-y-3">
                ...
                <motion.button
                  ...
                  {...press}
                  disabled={loading}
                  className="w-full bg-[#111] text-white rounded-md py-2.5 text-sm font-medium hover:bg-[#333] transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
            ...
            {authMethod === 'phone' && phoneStep === 'input' && (
              <motion.form variants={itemVariants} onSubmit={handleSendOtp} className="space-y-3">
                ...
                <motion.button
                  ...
                  className="w-full bg-[#111] text-white rounded-md py-2.5 text-sm font-medium hover:bg-[#333] transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? <span className="inline-flex items-center gap-2"><Loader2 className="w-4 h-4 animate-spin" /> Sending…</span> : 'Send OTP'}
                </motion.button>
              </motion.form>
            )}
            ...
            {authMethod === 'phone' && phoneStep === 'verify' && (
              <motion.form variants={itemVariants} onSubmit={handleVerifyOtp} className="space-y-3">
                ...
                <motion.button
                  ...
                  className="w-full bg-[#111] text-white rounded-md py-2.5 text-sm font-medium hover:bg-[#333] transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? <span className="inline-flex items-center gap-2"><Loader2 className="w-4 h-4 animate-spin" /> Verifying…</span> : 'Verify OTP'}
                </motion.button>
              </motion.form>
            )}
            ...
            <motion.button
              ...
              disabled={loading}
              className="w-full border border-[#e5e3e3] rounded-md py-2.5 text-sm text-[#171717] flex items-center justify-center gap-2 hover:bg-[#f5f4f4] transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <span className="inline-flex items-center gap-2">
                  <Loader2 className="w-4 h-4 animate-spin" /> Signing in…
